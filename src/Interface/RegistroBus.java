...
public class RegistroBus extends javax.swing.JFrame {
    ...
    private final BusUpdater updater;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        char estado = jComboBox1.getSelectedItem().toString().charAt(0);
        String capacidad = jTextField4.getText();
        updater.registrarBus(placa, Integer.valueOf(capacidad), estado);
    }                                        
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        String placa = jTextField2.getText();
        char estado = jComboBox1.getSelectedItem().toString().charAt(0);
        updater.cambiarEstado(placa, estado);
    }                                        
